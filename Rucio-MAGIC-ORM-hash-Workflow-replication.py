...
class Rucio :
    ...
    def registerIntoGroup(self,n_file, new_dataset):
        ...
        print(self.myscope, n_file, new_dataset)
        #type_1 = self.client.get_did(scope=self.myscope, name=new_dataset.replace('/',''))
    ...
    def create_groups(self, organization) :
        ...
        self.registerIntoGroup(organization['fullname'].replace('+','_').replace('%','_'), organization['dataset_1'].replace('%','_'))
