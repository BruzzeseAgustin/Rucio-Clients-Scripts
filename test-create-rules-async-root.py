...
class Rucio :
    ...
    def outdated_register_replica(self, filemds, dest_RSE, org_RSE):
        ...
        for i in range(0,10):
            ...
            try:
                # do stuff
                rule = self.addReplicaRule_noasync(org_RSE, group=carrier_dataset)
                if rule != None :
                    rule_parent = rule
                print(rule_parent)
                break
        ...
        for dest in r1.destRse :
            ...
            # for n in range(0,20):
                ...
                # Else, if the files has no replica at destination RSE
                    ...
                    print('Replication performed between ',dest, group['container_3'])
...
if __name__ == '__main__':
    ...
    r1 = Rucio(myscope='test-root', orgRse='PIC-NON-DET', 
               destRse=['PIC-DET'], 
               account='root', working_folder='Server-test')
